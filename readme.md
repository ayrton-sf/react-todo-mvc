This project consists of code extracted from [TodoMVC](https://github.com/tastejs/todomvc).  
Original work © Addy Osmani, Sindre Sorhus, Pascal Hartig, and Stephen Sawchuk.  
Licensed under the [MIT License](https://github.com/tastejs/todomvc/blob/master/LICENSE).
